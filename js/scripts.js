$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      ...
      // Event start date
      start: new Date("April 19, 2025 07:00"),
      ...
      end: new Date("April 20, 2025 10:30"),

      // Event Address
      address:
        "Sri Durga Parameshwari Devi Temple Gaddanayakanahalli V||Vijaya Nagar Main Road || Devanahalli Taluk || Bangalore",

      // Event Description
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact Mr. Shiva Reddy at +91 6363482427.",
    },
  });
...
// Google map
// Google Map for Wedding Location
function initMap() {
  var templeLocation = { lat: 13.262230976143096, lng: 77.77996564592097 };
  ...
  var marker = new google.maps.Marker({
    ...
    map: map,
    title: "DURGAMAHESHWARI TEMPLE, GADDADANAYAKANAHALLI",
  });
}
